...
public class Main {
    ...
    private static void processFile(File file) throws IOException {
        ...
        // Escribir el código de tres direcciones con formato
        String threeAddressCodePath = OUTPUT_DIR + baseFileName + "_three_address_code.txt";
        String threeAddressCodeContent = String.join(System.lineSeparator(), visitor.getThreeAddressCode());
        Files.write(Paths.get(threeAddressCodePath), threeAddressCodeContent.getBytes());
    
        // Escribir el código optimizado con formato
        String optimizedCodePath = OUTPUT_DIR + baseFileName + "_optimized_code.txt";
        String optimizedCodeContent = String.join(System.lineSeparator(), visitor.getOptimizedCode());
        Files.write(Paths.get(optimizedCodePath), optimizedCodeContent.getBytes());
